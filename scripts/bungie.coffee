...
sendHelp = (robot, res) ->
  ...
  attachment =
    ...
    text: "You can show off your weapons by messaging the bot with your gamertag, network, and weapon slot, separated by spaces. The standard usage looks like this: \n```@ghost: MyGamerTag titan playstation primary```\nIf you only care about xbox, you can leave off the system:```@ghost: MyGamerTag warlock special```\nIf you've set up your slack profile so that your Slack username matches your gamertag, you can omit this too:```@ghost: hunter special```\n If you omit the character class, it will choose the last played:```@ghost: heavy```\n *Special note:*\n If your gamertag has any spaces in it, these will need to be substituted with underscores (\"_\") in order for the bot to recognize the input properly. #{admin_message}"
    mrkdwn_in: ["text"]
    fallback: "You can show off your weapons by messaging the bot with your gamertag, network, and weapon slot, separated by spaces. The standard usage looks like this: \n\"@ghost: MyGamerTag titan playstation primary\"\nIf you only care about xbox, you can leave off the system: \"@ghost: MyGamerTag warlock special\"\nIf you've set up your slack profile so that your Slack username matches your gamertag, you can omit this too: \"@ghost: hunter special\"\n If you omit the character class, it will choose the last played: \"@ghost: heavy\"\n SPECIAL NOTE:\n If your gamertag has any spaces in it, these will need to be substituted with underscores (\"_\") in order for the bot to recognize the input properly. #{admin_message}"
